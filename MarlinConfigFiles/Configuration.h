...
#define CUSTOM_MACHINE_NAME "Angel"//AH

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like https://www.uuidgenerator.net/version4
#define MACHINE_UUID "a3b4d936-84f4-4481-827e-e710c23f43a9"//AH
 ...
 */
#define X_DRIVER_TYPE  DRV8825//AH
#define Y_DRIVER_TYPE  DRV8825//AH
#define Z_DRIVER_TYPE  DRV8825//AH
...
#define E0_DRIVER_TYPE DRV8825//AH
...
#define TEMP_SENSOR_BED 1000//AH
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp 19.85//AH
    #define DEFAULT_Ki 1.44//AH
    #define DEFAULT_Kd 68.29//AH
  #endif
#endif
 ...
 */
#define MAX_BED_POWER 235 // limits duty cycle to bed; 255=full current//AH
  ...
  #define DEFAULT_bedKp 59.47//AH
  #define DEFAULT_bedKi 11.71//AH
  #define DEFAULT_bedKd 201.37//AH
...
#define X_MIN_ENDSTOP_INVERTING true // Set to true to invert the logic of the endstop. AH
#define Y_MIN_ENDSTOP_INVERTING true // Set to true to invert the logic of the endstop.
#define Z_MIN_ENDSTOP_INVERTING true // Set to true to invert the logic of the endstop. AH
...
#define Y_MAX_ENDSTOP_INVERTING true // Set to true to invert the logic of the endstop. AH
...
#define ENDSTOP_INTERRUPTS_FEATURE//AH
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 106.6, 106.6, 789.2, 203 } //AH
...
#define X_BED_SIZE 80//AH
#define Y_BED_SIZE 100//AH

// Travel limits (linear=mm, rotational=°) after homing, corresponding to endstop positions.
#define X_MIN_POS -10//AH
#define Y_MIN_POS -13//AH
#define Z_MIN_POS 0//AH
#define X_MAX_POS 89//AH
#define Y_MAX_POS 104//AH
#define Z_MAX_POS 100//AH
//#define I_MIN_POS 0
//#define I_MAX_POS 50
//#define J_MIN_POS 0
//#define J_MAX_POS 50
 ...
 */
#define EEPROM_SETTINGS     // Persistent storage with M500 and M501 //AH
