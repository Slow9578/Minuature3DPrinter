...
//
  ...
  #define BED_BETA                        4263 // Beta value AH
 ...
 */
#define INPUT_SHAPING_X//AH
#define INPUT_SHAPING_Y//AH
 ...
 */
#define LIN_ADVANCE//AH
#if ENABLED(LIN_ADVANCE)
  #if ENABLED(DISTINCT_E_FACTORS)
    #define ADVANCE_K { 0.22 }    // (mm) Compression length per 1mm/s extruder speed, per extruder
  #else
    #define ADVANCE_K 0.16 //AH        // (mm) Compression length applying to all extruders
  #endif
 ...
 */
#define MINIMUM_STEPPER_POST_DIR_DELAY 400 //AH
#define MINIMUM_STEPPER_PRE_DIR_DELAY 400  //AH
 ...
 * Override the default value based on the driver type set in Configuration.h.
 */
#define MINIMUM_STEPPER_PULSE 0 //AH
 ...
 * Override the default value based on the driver type set in Configuration.h.
 */
#define MAXIMUM_STEPPER_RATE 700000 //AH

// @section temperature

// Control heater 0 and heater 1 in parallel.
#define HEATERS_PARALLEL //AH
